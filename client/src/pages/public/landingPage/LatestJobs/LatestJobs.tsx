...
const annoncesMock = [
  { titre: 'Aide vendanges', departement: 'Gironde', postesRestants: 2, cropType: 'Crop_Cereals' as const },
  { titre: 'Récolte de pommes', departement: 'Tarn-et-Garonne', postesRestants: 4, cropType: 'Crop_Fruits' as const },
  { titre: 'Cueillette de prunes', departement: 'Lot-et-Garonne', postesRestants: 1, cropType: 'Crop_Fruits' as const },
  { titre: 'Maraîchage saison', departement: 'Gers', postesRestants: 3, cropType: 'Crop_Vegetables' as const },
  { titre: 'Taille de vigne', departement: 'Hérault', postesRestants: 5, cropType: 'Crop_Cereals' as const },
]
