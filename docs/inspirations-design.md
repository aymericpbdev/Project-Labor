# Inspirations Design — Project Labor

> Benchmark UI/UX de plateformes accessibles à des professionnels de terrain peu à l'aise avec le numérique.  
> Cible visée : agriculteurs et saisonniers, connexion parfois limitée.

---

## Sommaire

1. [Hellowork — Résultats de recherche mobile](#1-hellowork--résultats-de-recherche-mobile)
2. [Indeed — Fiche offre d'emploi mobile](#2-indeed--fiche-offre-demploi-mobile)
3. [AlloVoisins — Création de demande](#3-allovoisins--création-de-demande)
4. [Habitatpresto — Formulaire guidé par étapes](#4-habitatpresto--formulaire-guidé-par-étapes)
5. [Adecco & Moi — Dashboard mission intérim](#5-adecco--moi--dashboard-mission-intérim)
6. [Welcome to the Jungle — Fiche offre enrichie](#6-welcome-to-the-jungle--fiche-offre-enrichie)
7. [Jobagri — Recherche d'offres spécialisée agricole](#7-jobagri--recherche-doffres-spécialisée-agricole)
8. [ANEFA — Carrousel métiers illustrés](#8-anefa--carrousel-métiers-illustrés)
9. [Jobopré (ANEFA) — Carte géolocalisée](#9-jobopré-anefa--carte-géolocalisée)
10. [L'Agriculture recrute — Accueil national](#10-lagriculture-recrute--accueil-national)
11. [Travaux.com — Formulaire](#11-travauxcom--formulaire)
12. [StarOfService](#12-starofservice)
13. [WiziFarm](#13-wizifarm)
14. [La Ruche qui dit Oui](#14-la-ruche-qui-dit-oui)
15. [Synthèse](#synthèse)

---

## 1. Hellowork — Résultats de recherche mobile

**Type d'écran :** Liste de résultats 
...
Chaque carte montre le logo de l'entreprise, le salaire mensuel en gras, la durée du contrat et la date de publication. Tout ce qu'un saisonnier a besoin de savoir pour décider si ça l'intéresse — sans ouvrir la fiche.  
La deuxième carte utilise une photo de terrain (engin agricole). Ça parle immédiatement à quelqu'un du métier.

---

## 2. Indeed — Fiche offre d'emploi

**Type d'écran :** Détail d'une offre (site responsive)  
...
La description est tronquée avec "Afficher plus" — le texte long ne bloque pas l'accès au bouton d'action.  
"Postuler maintenant" est fixe en bas d'écran, toujours visible. Gros bouton bleu pleine largeur, impossible à rater même avec des doigts sales ou en plein soleil.

---

## 3. AlloVoisins — Création de demande

**Type d'écran :** Modale de publication  
...
Les questions sont en langage parlé : "De quoi avez-vous besoin ?", "De qui avez-vous besoin ?", "Où se situe votre besoin ?". On dirait une conversation, pas un formulaire administratif.  
Les 3 emplacements photo sont là mais vides — ça incite sans bloquer.  
La carte se remplit automatiquement par géolocalisation. L'utilisateur n'a rien à taper pour indiquer où il est.  
Le "Délai estimé avant première réponse" rassure avant même de publier : quelqu'un va répondre.

---

## 4. Habitatpresto — Formulaire guidé par étapes

**Type d'écran :** Formulaire de demande de devis  
...
Les catégories sont présentées avec des grandes icônes illustrées (Chauffage, Plomberie…) — l'utilisateur tape sur une image plutôt que de lire un menu déroulant. Pour quelqu'un qui a l'habitude de reconnaître des outils plutôt que de lire des mots, c'est naturel.  
Le hero affiche la réassurance immédiatement : "5 devis gratuits en 48h", "5000 professionnels", "30 000 avis clients". La confiance est posée avant même d'interagir.

---

## 5. Adecco & Moi — Dashboard mission intérim

**Type d'écran :** Accueil intérimaire connecté 
...
La carte mission regroupe tout ce dont l'intérimaire a besoin pour sa journée : dates, horaires exacts, taux horaire, adresse du site. Zéro navigation pour trouver "je dois être où à quelle heure".  
Les deux boutons d'action ("Déclarer absence" / "Signer contrat") sont côte à côte, directement sous les infos de la mission. L'action suit logiquement la lecture.  
L'accès rapide en grille 2×2 (acompte, bulletins, contrats, documents) couvre les 4 besoins les plus fréquents d'un intérimaire terrain. Tout est à un tap de l'accueil.  
La bottom navigation à 4 onglets (Accueil, Offres, Missions, Profil) est stable et sobre.

---

## 6. Welcome to the Jungle — Fiche offre enrichie

**Type d'écran :** Détail d'une offre 
...
Les tags en pills grises (CDD/Temporaire, lieu, télétravail, salaire) sont tous visibles sans scroller. Un scan de 3 secondes donne les infos clés.  
La description utilise un ton engageant avec des emojis ("🌾 Vivez l'été au cœur de nos campagnes"). Ça parle à quelqu'un qui cherche une aventure, pas juste un bulletin de paie.  
La barre fixe en bas avec "Postuler" (jaune, bien visible) et "Sauvegarder" donne deux choix simples : j'y vais maintenant ou je garde pour plus tard.

---

## 7. Jobagri — Recherche d'offres spécialisée agricole

**Type d'écran :** Recherche filtrée par secteur 
...
Les tags de secteur sont spécialisés et colorés par famille : "Production grande culture" en vert, "Viticulture" en orange, "Agroéquipement" en bleu. Cette granularité parle directement au métier — aucun job board généraliste ne propose ça.  
Le bouton "Postuler" vert est visible directement sur chaque carte, à côté du salaire. Pas besoin d'ouvrir la fiche pour agir.

---

## 8. ANEFA — Carrousel métiers illustrés

**Type d'écran :** Page d'accueil / découverte métiers 
...
Le format carrousel horizontal est adapté au scroll mobile au pouce. L'utilisateur découvre les métiers comme il scrolle Instagram — geste naturel, aucun apprentissage nécessaire.  
Chaque carte a un bouton play (▶) qui laisse supposer une vidéo ou fiche détaillée. L'entrée par l'image fonctionne pour quelqu'un qui ne sait pas forcément nommer son métier mais le reconnaît en photo.

---

## 9. Jobopré (ANEFA) — Carte géolocalisée

**Type d'écran :** Écran principal / recherche d'offres   
...
Les filtres sont liés au métier : type de culture, hébergement, dates de saison. Aucun filtre générique type "catégorie professionnelle" ou "niveau d'études".  
La fiche offre donne directement le numéro de téléphone de l'exploitant. Pas de messagerie interne — un saisonnier préfère appeler.

---

## 10. L'Agriculture recrute — Accueil national

**Type d'écran :** Page d'accueil candidat 
...
La grille 2×2 (chercher un emploi, déposer mon CV, se former, fiches métiers) couvre les 4 besoins principaux d'un candidat. Pas de menu, pas de sous-pages — tout est à un tap.  
La navigation par région avec compteur d'offres (Nouvelle-Aquitaine : 847, Occitanie : 623…) permet de jauger l'activité dans sa zone en un coup d'œil.

---

## 11. Travaux.com — Formulaire

**Type d'écran :** Formulaire de publication 
...
"Nous vous rappelons" plutôt que "Envoyez-nous un message". Le canal par défaut c'est le téléphone, pas l'écrit.  
Chaque produit a un nom simple et une ligne. Mission, Paie'Saisonnier, Petits comptes entre agris — un exploitant comprend en 5 secondes ce qui le concerne.

---

## 14. La Ruche qui dit Oui
...
Trois pictogrammes résument l'ensemble. Agriculteur, bio, saison — compréhension aisée.
